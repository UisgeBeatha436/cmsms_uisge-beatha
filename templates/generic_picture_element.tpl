{if isset($picture_element)}
    ...
    {else}
        <img data-image="0"{if $picture_element[0].style !=''} style="{$picture_element[0].style}"{/if}{if $picture_element[0].class !=''} class="{$picture_element[0].class}"{/if} data-src="{$picture_element[0].src}" alt="{$picture_element[0].alt}">
    {/if}
{/if}